...
class TotalField extends Component {
    ...
    render() {
        ...
        return (
            <div className={"table-cell " + this.fieldSelectedClass() + this.fieldActiveClass() + this.fieldIndexClass()}>
                {this.props.total}
            </div>
        );
        // let content = '';
        ...
        // }
        // return (
        //     <div className={"table-cell " + this.fieldSelectedClass() + this.fieldActiveClass()}>
